### This project uses Tensorflow's Object Detection api to make realtime object detection in a video.
...
#### Make sure you have Python>=3.7 installed in your machine, if not then download and install it [here.](https://www.python.org/)
  ...
  - 2] [Clone](https://docs.github.com/en/github/creating-cloning-and-archiving-repositories/cloning-a-repository) or Download the official repository of [tensorflow-object-detection-api](https://github.com/tensorflow/models) from Github.
